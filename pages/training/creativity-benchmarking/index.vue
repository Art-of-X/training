    ...
    <div class="space-y-8">
      ...
      <div class="card dark:bg-secondary-800 dark:border-secondary-700">
        <div class="card-body">
          ...
          <p class="text-secondary-600 dark:text-secondary-300 mb-4">
            Measures verbal creativity. Name 10 words that are as semantically distant from each other as possible.
          </p>
          <NuxtLink to="/training/creativity-benchmarking/dat" class="btn-primary">
            {{ datProgress && datProgress.hasSubmitted ? 'Do It Again' : 'Start DAT' }}
          </NuxtLink>
        </div>
      </div>
    </div>
