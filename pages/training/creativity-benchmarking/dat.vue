      ...
      <div class="card-body">
        ...
        <div v-if="submissionSuccess" class="text-center">
            <div class="text-success-600 dark:text-success-400 flex flex-col items-center">
                ...
                <p class="text-secondary-600 dark:text-secondary-300 mb-6">Your list of words has been saved. Thank you!</p>
            </div>
            <button @click="startAgain" class="btn-primary">Start a New List</button>
        </div>
