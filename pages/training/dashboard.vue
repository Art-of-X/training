<template>
  <div class="h-screen">
    ...
    <div class="flex-grow grid grid-cols-1 md:grid-cols-3 gap-8 items-start px-8 pb-8 overflow-hidden container-wide">
...
import ChatComponent from '~/pages/training/chat.vue';
